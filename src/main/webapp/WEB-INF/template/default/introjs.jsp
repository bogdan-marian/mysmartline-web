...
<%
		...
		Cookie jspLogedIn = new Cookie("cookieLogedIn", "false");
		if (user != null) {
			logInOutUrl = userService.createLogoutURL("/");
			logInOutEmail = user.getEmail();
			logInOutText = "log out";
			logedIn = true;
			jspLogedIn = new Cookie("cookieLogedIn", "true");
		}
		jspLogedIn.setMaxAge(60*60*24);
		response.addCookie( jspLogedIn );
	%>
<html>
<head>
...
<!-- introJs -->
<link rel="stylesheet"
	href="<c:url value="/resources/introjs/introjs.css" />">
...
<body>
			...
			<div class="topbar">
				<div class="container">
					...
					<ul class="loginbar pull-right">
						...
						<li class="logInOut"><%=logInOutEmail%> <a href="<%=logInOutUrl%>"><%=logInOutText%></a></li>
					</ul>
						...
						<ul class="nav navbar-nav">
							...
							<li class="dropdown "><a href="javascript:void(0);"
								...
								<ul class="dropdown-menu">
									<li><a href="/Home/help1/1"> <spring:message
												code="menu.introduction" /></a></li>
									<li><a
										href="https://groups.google.com/forum/#!forum/my-smart-line-alpha">
											<spring:message code="menu.comunityHelp" />
									</a></li>
								</ul></li>
							<!-- End Tools -->
							<c:if test="<%=logedIn%>">
	...
	<!-- Intro js -->
	<script type="text/javascript"
		src="<c:url value="/resources/introjs/intro.js" />"></script>
	
	<script type="text/javascript"
		src="<c:url value="/resources/guideJs/guide.js" />"></script>
