				...
				<div class="col-md-6 col-sm-6">
					<div class="pricing hover-effect">
						<div class="pricing-head">
							...
							<h4>
								<span><spring:message code="pay.oneLineOneMonth.oneLineForOneMonth" /> = ${orderModel.pricingValue } &#x20AC </span>
							</h4>
							<h4>
						...
						<ul class="pricing-content list-unstyled">
							<li><i class="icon-users"></i> <spring:message code="pay.oneLineOneMonth.nrOfLinesForThisOrder" /> <span
