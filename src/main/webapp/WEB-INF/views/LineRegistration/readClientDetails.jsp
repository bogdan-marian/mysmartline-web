				...
				<div class="col-md-5 col-sm-6">
					<div class="pricing hover-effect">
						<div class="pricing-head">
							...
							<h4>
								<span><spring:message code="lineRegistration.readClientDetails.couldBeYourNumber" /></span>
							</h4>
						</div>
							...
							<p>
								<form:form role="form" method="post"
									...
									<button type="submit" class="btn-u fa fa-thumbs-up  rounded">
										<spring:message code="lineRegistration.readClientDetails.getInLine" /></button>
								</form:form>
							</p>
