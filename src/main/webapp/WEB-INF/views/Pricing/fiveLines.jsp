				...
				<div class="col-md-6 col-sm-6">
					<div class="pricing hover-effect">
						<div class="pricing-head">
							<h3>
								<spring:message code="pricing.fiveLines" />
							</h3>
						</div>
						...
						<div class="pricing-footer">
							<p>
								<a class="btn-u fa fa-thumbs-up  rounded" href="/Pay/fiveLinesOneMonth">40 &#x20AC / <spring:message code="pricing.month" /></a>
								<a class="btn-u fa fa-thumbs-up  rounded" href="/Pay/fiveLinesOneYear">440 &#x20AC / <spring:message code="pricing.year" /></a>
							</p>
						</div>
					</div>
				</div>
